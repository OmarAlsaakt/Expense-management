...
class ExpenseProvider with ChangeNotifier {
  ...
  void _loadExpensesFromStorage() async {
    ...
    if (storedExpenses != null) {
      try {
        var decodedExpenses = jsonDecode(storedExpenses) as List;
        _expenses = List<Expense>.from(
          decodedExpenses.map((item) => Expense.fromJson(item)),
        );
        notifyListeners();
      } catch (e) {
      ...
      print("No stored expenses found or the data is not a string.");
    }
  }
